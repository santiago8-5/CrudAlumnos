...
<div class="md:flex md:justify-center md:gap-10 md:items-center">
    ...
    <div class="md:w-4/12 p-5">
        <img src="{{$alumno->imagen ? asset('alumnosimg') . '/' . $alumno->imagen : asset('img/usuario.svg')}}" alt="Imagen DEL ALUMNO" class="rounded-full">
    </div>
        ...
        <div class="mt-4 text-xl">
            ...
            <div class="mb-10">
                <a href="{{route('alumnos.index')}}" class="bg-green-600 hover:bg-green-700 transition-colors cursor-pointer uppercase font-bold  p-2 text-white rounded-lg">          
                    ...
                    Regresar</a>
                <a href="{{route('alumnos.edit', $alumno)}}" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-2 text-white rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-black-500 inline font-bold">
            ...
            <div class="mb-10">
                ...
                <p class="font-bold mb-3 text-2xl">Información General del Alumno</p>
